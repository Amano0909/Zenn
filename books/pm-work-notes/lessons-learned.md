...
- Todoの洗い出し
  - いわゆる[WBS分解図](https://mynavi-creator.jp/blog/article/what-is-a-wbs)に近しい作業をしていきます
...
- ガントチャートの作成
  ...
  - 各Taskにかかる見積が完成したら次に優先順位を決めていきます。このときに役に立つのが[クリティカルパス](https://next-sfa.jp/journal/skill/criticalpath/)の考えです。クリティカルパス上のTaskに優先的に資源を投下しておくことで必要時間を最適化していきます。
...
- リスクの洗い出し
  ...
  - キックオフ資料の主要リスクの項目にPM視点でリスクをまとめていきます。
  - すべてのリスクに対応することはできないため、優先順位を決めると良きです。
    - 優先順位付けには[定性リスク分析](https://www.japan-project-solutions.com/what-is-qualitative-risk-analysis)などを利用しましょう

- ステークホルダーの洗い出し
  - 最後にキックオフ資料の「ステークホルダー・要求事項」をまとめていきます。
...
どうPJを回して行こうかと考えたときにいくつかのスクラムの考え方を取り入れることにしました。※これが正しいとは思っていませんし、PJが大きな規模になれば破綻するでしょう。ただ事業会社の中でPJを回す分にはなんとかなりました。
